...
function show_unquoted(io::IO, ex::Expr, indent::Int, prec::Int)
    ...
    elseif head === :return && nargs == 1 && is(args[1], nothing)
        print(io, head)
    ...
    elseif head === :string && nargs == 1 && isa(args[1], String)
        show(io, args[1])
    ...
    elseif head === :using || head === :import || head === :importall && nargs > 0
